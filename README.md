...
A deep learning project that uses **Long Short-Term Memory (LSTM)** neural networks to predict stock market closing prices and forecast future trends.

Built with `tensorflow.keras` and `scikit-learn`.

![LSTM Stock Prediction](lstm_stock_prediction.png)
